...
class _$TrainingBlockCopyWithImpl<$Res, $Val extends TrainingBlock>
  ...
  $Res call({
    ...
    Object? userId = null,
    Object? name = null,
    Object? exerciseDayOrdering = null,
  }) {
...
class _$_TrainingBlock with DiagnosticableTreeMixin implements _TrainingBlock {
  ...
  Map<String, int> get exerciseDayOrdering {
    ...
    return EqualUnmodifiableMapView(_exerciseDayOrdering);
  }

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TrainingBlock(id: $id, userId: $userId, name: $name, exerciseDayOrdering: $exerciseDayOrdering)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('exerciseDayOrdering', exerciseDayOrdering));
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._exerciseDayOrdering, _exerciseDayOrdering));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, userId, name,
      const DeepCollectionEquality().hash(_exerciseDayOrdering));
